...
const StickyGuideBanner = ({ guideType, label }: StickyGuideBannerProps) => {
 ...
 <p className="flex-1 text-[0.8125rem] font-medium text-primary-foreground leading-snug">
 {label}
 </p>
 <Button
 variant="accent"
 ...
 className="shrink-0 rounded-lg p-1.5 text-primary-foreground/40 hover:text-primary-foreground/70 hover:bg-white/5 transition-colors"
 aria-label="Fermer"
 >
 <X size={16} />
 </button>
 ...
 <GuideModal open={modalOpen} onOpenChange={setModalOpen} guideType={guideType} />
 </>
 );
};
