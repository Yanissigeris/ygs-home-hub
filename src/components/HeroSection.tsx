  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className="hero-fade-in absolute left-0 z-[5] w-1/2 pl-[18px] pr-4 text-left pointer-events-none md:w-full md:text-center md:bg-transparent md:backdrop-blur-0 md:!mx-0 md:!p-0 md:!rounded-none"
          style={{
            animationDelay: "0.5s",
            bottom: "32px",
        ...
        {/* ─── NAP (Layer 5) ─── */}
        <address
          className="hero-fade-in absolute left-0 z-[5] w-1/2 pl-[18px] pr-4 text-left not-italic pointer-events-none md:w-full md:text-center md:!pl-0 md:!pr-0"
          style={{
            animationDelay: "0.5s",
            bottom: "8px",
            color: "rgba(255,255,255,0.6)",
