        ...
        <div className="grid min-h-[100vh] lg:grid-cols-2">
          ...
          <div className="relative hidden lg:block overflow-hidden" style={{ background: "var(--ink2)" }}>
            ...
            {heroBgImage && !heroVideo && (
              <div className="absolute inset-0">
                <img src={heroBgImage} alt="" role="presentation" className="h-full w-full object-cover" <img src={heroBgImage} alt="" role="presentation" className="h-full w-full object-cover" style={{ opacity: 0.55, filter: "brightness(0.85) saturate(0.7)" }} loading="eager" onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} /> onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} />
              </div>
            )}
