  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-transparent border-[1.5px] border-[#A88A5A] text-[var(--gold-text)] hover:bg-[var(--gold-dark)] hover:text-white font-semibold rounded-none shadow-none transition-all duration-200 ease-out",
        ...
        accent: "bg-transparent border-[1.5px] border-[#A88A5A] text-[var(--gold-text)] hover:bg-[var(--gold-dark)] hover:text-white font-semibold rounded-none shadow-none transition-all duration-200 ease-out",
      },
      size: {
