    ...
    <div className="section-container">
      ...
      <motion.div
        ...
        transition={{ duration: 0.45, delay: i * 0.1, ease: [0.22, 1, 0.36, 1] }}>
            ...
            <Link to={step.href} className="card-elevated group flex h-full flex-col items-start border border-border/40 bg-card p-5 sm:p-8 transition-all duration-300 hover:border-accent/25 hover:shadow-[0_4px_24px_-6px_hsl(var(--accent)/0.10)] hover:-translate-y-0.5">
