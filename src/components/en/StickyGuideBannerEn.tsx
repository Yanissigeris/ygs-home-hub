...
const StickyGuideBannerEn = ({ guideType, label }: StickyGuideBannerEnProps) => {
  ...
  return (
    <>
      ...
      <GuideModalEn open={modalOpen} onOpenChange={setModalOpen} guideType={guideType} />
    </>
  );
};

export default StickyGuideBannerEn;
