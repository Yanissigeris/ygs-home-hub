...
const GuideInlineCTAEn = ({ guideType, headline, text, ctaLabel = "Get the free guide" }: GuideInlineCTAEnProps) => {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6">
              <div className="flex-1">
                <p className="flex items-center gap-2 text-[0.7rem] font-medium tracking-[0.12em] uppercase text-accent/80 mb-2">
                  <BookOpen size={13} className="text-accent" />Free Guide
                </p>
                ...
                <div className="mt-2 flex gap-4 text-[0.7rem] text-primary-foreground/40">
                  <span className="flex items-center gap-1"><BadgeCheck size={11} /> Free</span>
                  <span className="flex items-center gap-1"><Lock size={11} /> No commitment</span>
                </div>
              </div>
...
export default GuideInlineCTAEn;
