...
<section className="section-padding bg-background">
    <div className="section-container grid gap-12 lg:gap-14 lg:grid-cols-[42%_58%] lg:items-center">
      ...
      transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1], delay: 0.15 }}>
        ...
        <p className="prose-body mt-4">Avec plus de 9 ans d’expérience comme courtier immobilier en Outaouais, Yanis offre à ses clients un accompagnement solide, stratégique et rassurant du début à la fin de la transaction. Investisseur immobilier lui-même, il sait également analyser en profondeur les opportunités en multilogement. Son expérience concrète en flips immobiliers, combinée à sa formation en gestion de projet (AEC), fait de lui un allié incontournable pour tout projet immobilier.                                        
