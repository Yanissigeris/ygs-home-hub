            ...
            {affiliationLogos.map((logo) => (
              ...
              >
                <img
                  src={logo.src}
                  alt={logo.alt}
                  className="h-full max-h-[28px] w-auto max-w-[72px] object-contain opacity-40 brightness-0 invert transition-opacity duration-300 hover:opacity-60 sm:max-h-[32px] sm:max-w-[80px] lg:max-h-[30px] lg:max-w-[76px]"
                />
              </div>
            ))}
          </div>
