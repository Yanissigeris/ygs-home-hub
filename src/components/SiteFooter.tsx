    ...
    return (
      <footer ref={ref} className={className} style={{ background: "var(--ink)", color: "#fff", paddingBottom: "env(safe-area-inset-bottom, 0px)" }} {...props}>
        <div className="section-container">
          ...
          {/* ── NAP ── */}         <div className="py-4 text-center" style={{ borderTop: "1px solid rgba(255,255,255,.06)" }}>           <p style={{ fontSize: ".68rem", color: "rgba(255,255,255,.3)", fontWeight: 300 }}>             {lang === "en" ? "819-210-3044" : "819-210-3044"}             {" · "}             <a href="mailto:yanis@martywaite.com" style={{ color: "rgba(255,255,255,.3)" }}>yanis@martywaite.com</a>             {" · "}             {lang === "en" ? "452 Jean-Perrin, Gatineau, QC J8V 2R3" : "452 rue Jean-Perrin, Gatineau, QC J8V 2R3"}           </p>         </div>         {/* ── Copyright ── */}
