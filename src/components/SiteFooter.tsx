  ...
  <footer className="border-t border-border bg-primary text-primary-foreground">
    <div className="section-container pt-16 pb-8 sm:pt-[4.5rem] sm:pb-8">
      <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-8 flex items-center gap-5">
            <img
              ...
              style={{ height: "clamp(44px, 6vw, 54px)" }}
            />
            <img
              src={logoRemax}
              alt="RE/MAX"
        ...
        {/* Sectors */}
        <div>
          <p className="mb-4 font-body text-[0.75rem] font-semibold uppercase tracking-[0.12em] opacity-35">Secteurs desservis</p>
          <p className="text-[0.875rem] leading-[1.6] opacity-55">
