...
const UtilityBar = React.forwardRef<HTMLDivElement>((_, ref) => (
  <div ref={ref}>
    ...
    <div className="border-b border-white/[0.06] bg-[hsl(200,42%,16%)] sm:hidden">
      <div className="flex h-[34px] items-center justify-between px-5">
        <a href="tel:+18195551234" className="flex items-center gap-2 text-[0.7188rem] text-white/55 transition-colors hover:text-white/85">
          <Phone size={11} strokeWidth={1.5} className="text-white/35" />
          <span>819-210-3044</span>
        </a>
        <Link
          to="/evaluation-gratuite-gatineau"
          className="inline-flex h-[24px] items-center rounded-full border border-white/[0.08] bg-white/[0.09] px-3.5 text-[0.6563rem] font-medium tracking-[0.04em] text-white/80 transition-all duration-200 hover:bg-white/[0.14] hover:text-white/95"
        >
          Évaluation gratuite
        </Link>
      </div>
