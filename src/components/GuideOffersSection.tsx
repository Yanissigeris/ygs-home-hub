      ...
      <section className="relative overflow-hidden section-rhythm section-gold-divider" style={{ background: "var(--white)" }}>
        ...
        <div className="section-container relative">
          ...
          <div className="mb-8 sm:mb-12 max-w-[36rem]">
            <p className="label-overline mb-2" style={{ color: "var(--gold-dark)" }}>{heading.overline}</p>
            <h2>{heading.title}</h2>
          ...
          <div className="hidden md:grid grid-cols-1 min-[481px]:grid-cols-2 lg:grid-cols-4">
            {guides.map((g, i) => (
              ...
              >
                ...
                <span aria-hidden="true" className="mt-4 inline-flex items-center gap-1 transition-all group-hover:gap-2 group-focus-visible:gap-2" style={{ fontSize: ".72rem", fontWeight: 700, color: "var(--gold-dark)", letterSpacing: ".06em", textTransform: "uppercase" as const, minHeight: 44, display: "inline-flex", alignItems: "center" }}>{g.cta}</span>
              </button>
            ))}
          </div>
          ...
          <div className="md:hidden grid grid-cols-2" style={{ gap: 1, background: "var(--border)" }}>
            {guides.map((g) => (
              ...
              >
                ...
                <span aria-hidden="true" className="mt-3 inline-flex items-center" style={{ fontSize: ".7rem", fontWeight: 700, color: "var(--gold-dark)", letterSpacing: ".06em", textTransform: "uppercase" as const, lineHeight: 1.3, minHeight: 44 }}>
