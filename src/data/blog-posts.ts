...
*Yanis Gauthier-Sigeris, RE/MAX broker in the Outaouais for 9 years, specialized in plex and investment in [Gatineau](/en/gatineau), [Hull](/en/hull) and [Aylmer](/en/aylmer). Over 200 completed transactions in the region.*`,
  },
  {
    ...
    ctaOverride: {
      ...
      text: "Je fais une évaluation de votre propriété basée sur les comparables exacts du T1 2026 sur votre secteur, pas une fourchette générique.",
      buttonLabel: "Évaluation gratuite",
      buttonHref: "/evaluation-gratuite-gatineau/",
      eyebrowEn: "PERSONALIZED VALUATION",
      titleEn: "Thinking about selling in the next six months?",
      textEn: "I provide a property valuation based on exact comparables from Q1 2026 in your area, not a generic price range.",
...
Don't let the tax rate discourage you from buying in Gatineau. Look at the complete picture. I help you make the personalized calculation for your situation.`,
  },
  {
    ...
    title: "Les meilleurs quartiers pour une famille à Gatineau",
