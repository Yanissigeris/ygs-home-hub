...
export const propertiesEn: Property[] = [
  ...
  },
  {
    ...
    powderRooms: "1",
    area: "1 042 sq ft",
    lotSize: "45 793 sq ft",
    yearBuilt: "1995",
    description:
      "A true nature retreat minutes from the city: wooded lot of 45 793 sq ft with no rear neighbors, offering privacy, tranquility and an outdoor lifestyle. Renovated 3-bedroom home, open-concept layout, garage and parking for multiple vehicles.",
    image: property28743871,
    remaxUrl:
      "https://www.remax-quebec.com/en/properties/house-for-sale-outaouais/10-rue-laviolette-cantley-cantley-28743871",
    mls: "28743871",
    status: "sold",
  },
  {
    id: "19674845",
    address: "310 Boul. d'Europe, apt. 6",
    city: "Gatineau (Aylmer, Plateau de la Capitale)",
    price: "$1,975/month",
    type: "Condo — Apartment (for rent)",
    bedrooms: "2",
    bathrooms: "1",
    area: "1,240 sq ft",
    yearBuilt: "2009",
    description:
      "Bright 2-bedroom condo in Plateau de la Capitale. 9-ft ceilings, appliances included, wall-mounted A/C, 1 parking spot, private shed and patio. Available June 1, 2026.",
  ...
  {
    id: "26501194",
    address: "383 Boul. des Grives, apt. 4",
    city: "Gatineau (Hull, Plateau de la Capitale)",
    price: "$294,900",
  ...
  },
  {
    ...
    bedrooms: "—",
    bathrooms: "—",
    area: "1.7 acres (6,884.7 m²)",
    lotSize: "1.7 acres",
    description:
      "Beautiful 1.7-acre wooded lot (6,884.7 m²) with potential views of Lake Newcombe. A rare find: acquired rights and access are confirmed in writing by the Municipality, letter on file, and the lot benefits from a notarized, perpetual right of way from Chemin du Fort, on foot and by vehicle. Set back from the road, about 30 minutes from Gatineau, it offers a peaceful, private setting surrounded by nature — ideal for your building project. Electricity available at the road.",
