   ...
   <>
    ...
    <ContentBlock narrow>
      ...
      <p className="prose-body mt-4">
        Après depuis 2017 à accompagner des vendeurs en Outaouais, j'ai vu ce qui fonctionne et ce qui fait perdre de l'argent. Ce guide résume les leçons les plus importantes.
      </p>
    </ContentBlock>
