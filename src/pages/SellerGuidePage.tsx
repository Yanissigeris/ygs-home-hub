...
const topics = ["Comment fixer le bon prix de vente à Gatineau","Les erreurs qui font perdre des milliers de dollars","Préparer sa propriété sans trop investir","Le processus de vente étape par étape au Québec","Négociation: protéger votre prix avec la bonne stratégie","Coordination vente-achat: éviter d'être coincé",
];
