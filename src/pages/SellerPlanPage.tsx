...
const benefits = ["Évaluation réaliste basée sur les ventes comparables récentes","Avis sur les améliorations qui valent la peine (ou pas)","Positionnement prix stratégique pour votre secteur","Plan de mise en marché personnalisé","Calendrier et coordination si vous achetez en parallèle",
];
