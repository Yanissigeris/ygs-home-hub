...
const reasons = ["Développements récents avec maisons modernes","Quartiers familiaux avec parcs et pistes cyclables","Écoles et garderies de proximité","Accès rapide à Ottawa et au centre-ville de Gatineau","Excellent rapport qualité-prix pour les jeunes familles",
];
