...
const topics = ["Comprendre le marché immobilier de Gatineau vs Ottawa et Montréal","Choisir le bon secteur pour votre famille et votre budget","Le processus d'achat et d'installation au Québec","Écoles, services, transports — ce qu'il faut savoir","Taxes, coût de la vie et avantages fiscaux","Les erreurs à éviter lors d'une relocalisation",
];
