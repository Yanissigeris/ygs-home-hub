...
<ContentBlock narrow>
      ...
      <p className="prose-body mt-4">
        Depuis 2017 à accompagner des vendeurs en Outaouais, je connais les comparables, les tendances et les acheteurs actifs à Aylmer. Mon objectif : un plan clair pour vendre au meilleur prix, sans surprises.
      </p>
    </ContentBlock>
