...
const LivingHullPage = () => (
   <>
    <PageMeta title="Vivre à Hull · Gatineau — Mode de vie | YGS" description="Tout sur la vie à Hull, Gatineau: culture, restaurants, proximité Ottawa, projet Zibi et ambiance urbaine. Le guide pour s'installer à Hull." />
    <HeroSection
