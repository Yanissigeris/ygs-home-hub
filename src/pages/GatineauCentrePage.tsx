...
const GatineauCentrePage = () => (
  <>
    <PageMeta
      ...
      description="Achetez, vendez ou investissez à Gatineau centre. Plexs, maisons unifamiliales, condos. Courtier local depuis près de 9 ans — Yanis Gauthier-Sigeris."
    />
    <NeighborhoodJsonLd
