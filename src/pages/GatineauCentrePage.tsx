...
const reasons = ["Quartier résidentiel bien établi avec tous les services","Accès rapide aux autoroutes et au centre-ville","Bonnes écoles et parcs familiaux","Marché immobilier diversifié — maisons, jumelés, condos","Prix compétitifs par rapport à Aylmer et Hull",
];
