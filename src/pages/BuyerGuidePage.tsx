...
const topics = ["Comprendre le processus d'achat au Québec","Choisir le bon secteur à Gatineau ou en Outaouais pour votre profil","Premier achat vs acheteur expérimenté — ce qui change","Comment formuler une offre solide","L'inspection: ce qu'il faut vraiment vérifier","Le rôle du notaire et les frais à prévoir",
];
