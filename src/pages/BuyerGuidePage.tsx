...
const BuyerGuidePage = () => (
   <>
    <PageMeta title="Guide acheteur — Acheter à Gatineau | YGS" description="Guide complet pour acheter une propriété à Gatineau et en Outaouais. Processus québécois, budget, inspection et négociation — tout ce qu'il faut savoir." />
    <HeroSection
