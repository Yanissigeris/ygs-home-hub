...
const reasons = ["Terrains plus grands et propriétés plus spacieuses","Prix d'entrée parmi les plus accessibles de l'Outaouais","Cadre naturel — rivières, parcs, espaces verts","Idéal pour les familles qui veulent de l'espace sans quitter la région","Secteur en croissance avec de nouveaux développements",
];
...
const sellerReasons = ["La demande augmente dans le secteur avec les nouveaux développements","Les acheteurs cherchent de l'espace — votre propriété les intéresse","Profiter de la hausse de valeur avant que les prix se stabilisent","Optimiser votre position pour votre prochain projet immobilier",
];
