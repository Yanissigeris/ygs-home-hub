...
const faq = [
  ...
  { q: "Quel sont les prix des maisons déjà vendu à Gatineau?", a: "Les prix de vente ne sont pas publics au Québec. En tant que courtier, j'ai accès aux données — demandez votre évaluation gratuite." },
