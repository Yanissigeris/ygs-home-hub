...
const faq = [
  ...
  { q: "Où trouver les prix de vente réels à Gatineau?", a: "Les prix de vente ne sont pas publics au Québec. En tant que courtier, j'ai accès aux données — demandez votre évaluation gratuite." },
