...
const reasons = ["Centre-ville animé avec restaurants, culture et vie de quartier","Proximité immédiate du centre-ville d'Ottawa via les ponts","Condos, plex et maisons à prix compétitifs","Secteur en revitalisation avec potentiel de plus-value","Transports en commun et pistes cyclables bien développés",
];
...
const sellerReasons = ["Le marché de Hull attire de plus en plus d'acheteurs","La revitalisation du secteur augmente l'intérêt","Forte demande pour les plex et condos bien situés","C'est peut-être le meilleur moment pour maximiser votre prix",
];
