...
const topics = ["Understanding the Gatineau real estate market vs Ottawa and Montréal","Choosing the right neighborhood for your family and budget","The buying and settling process in Québec","Schools, services, transportation — what you need to know","Taxes, cost of living and tax advantages","Mistakes to avoid during a relocation",
];
...
const RelocationGuidePageEn = () => (
 ...
 <CTASection dark title="Let's plan your move" text="Book a free call — let's clarify your options and next steps." buttons={[{ label:"Book a call", href:"/en/contact" }, { label:"Explore neighborhoods", href:"/en/neighborhoods", variant:"outline" }]} trustLine="I give you the options, you decide." />
 </>
);
