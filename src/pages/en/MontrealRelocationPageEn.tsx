...
const MontrealRelocationPageEn = () => (
 ...
 trustLine="Relocation specialist."
 heroBgImage={heroImg}
 />
 ...
 <CTASection dark title="Ready to explore Gatineau?" text="Book a free call — let's look at neighborhoods and options together." buttons={[{ label:"Book a call", href:"/en/contact" }, { label:"Explore neighborhoods", href:"/en/neighborhoods", variant:"outline" }]} trustLine="I give you the options, you decide." />
