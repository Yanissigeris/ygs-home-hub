  ...
  return (
    <>
      ...
      <CTASection
        ...
        text="I have been covering the Municipality of Pontiac for since 2017. I know the areas, the comparables, and the practical realities — wells, septic systems, zoning, access. If you have a project here, I am your local broker."
        buttons={[
