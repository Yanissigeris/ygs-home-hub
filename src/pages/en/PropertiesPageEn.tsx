...
const PropertiesPageEn = () => (
 ...
 <CTASection dark title="Looking for a property in Gatineau?" text="Tell me your criteria — I'll send you the best options before anyone else." buttons={[{ label:"Book a consultation", href:"/en/buyer-consultation" }, { label:"Explore neighborhoods", href:"/en/neighborhoods", variant:"outline" }]} trustLine="I give you the options, you decide." />
 </>
);
