...
<ContentBlock narrow>
      ...
      <p className="prose-body mt-4">
        With since 2017 helping sellers across Outaouais, I know the comparables, active buyers and specifics of each Hull neighborhood. My goal: give you a clear plan to sell at the best price, with no surprises.
      </p>
    </ContentBlock>
