...
const topics = ["Understanding the realities of a real estate posting","Buying vs renting during a military relocation","Best Gatineau neighborhoods for military families","The buying process in Québec — step by step","Selling quickly during a posting without sacrificing price","Programs and resources available for military members",
];
...
const MilitaryGuidePageEn = () => (
 ...
 <CTASection dark title="Let's plan your military relocation" text="Book a free call — we adapt the plan to your posting and timeline." buttons={[{ label:"Book a call", href:"/en/contact" }, { label:"Free Valuation", href:"/en/home-valuation", variant:"outline" }]} trustLine="I adapt to your pace." />
