...
const benefits = ["Realistic valuation based on recent comparable sales","Advice on improvements that are worth it (or not)","Strategic price positioning for your area","Personalized marketing plan","Timeline and coordination if you're buying in parallel",
];
...
const SellerPlanPageEn = () => {
 ...
 I give you the numbers and options, you decide.
 </p>
 </form>
 )}
 </div>
