...
const benefits = ["Current market value estimate of your plex","Rental revenue vs actual expense analysis","Rent optimization potential","Recommendation: hold, sell or refinance","Concrete next steps, no commitment",
];
...
const faq = [
 ...
 { q:"Is it really free?", a:"Yes. The goal is to help you make an informed decision. If you decide to move forward, we discuss it — but." },
