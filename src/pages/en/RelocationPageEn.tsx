...
const RelocationPageEn = () => (
  <>
    <PageMeta title="Relocation Ottawa to Gatineau" description="Moving from Ottawa to Gatineau? Complete guide: neighborhoods, taxes, schools and personalized real estate support." ogImage="https://yanisgauthier.com/og-relocation.jpg" />
