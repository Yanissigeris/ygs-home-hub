...
const RelocationPageEn = () => (
 ...
 <HeroSection overline="Ottawa → Gatineau" title="Relocating to Gatineau from Ottawa or beyond" subtitle="Thinking about crossing the river? I help you understand the neighborhoods, prices, process and find the right property — stress-free." primaryCta={{ label:"Book a call", href:"/en/contact" }} secondaryCta={{ label:"Relocation Guide", href:"/en/relocation-guide" }} trustLine="Clear strategy. No bad surprises." heroBgImage={heroImg} />
