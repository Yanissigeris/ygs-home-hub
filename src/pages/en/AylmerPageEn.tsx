...
const AylmerPageEn = () => (
  <>
    <PageMeta title="Real Estate Broker Aylmer · Gatineau" description="Real estate broker in Aylmer, Gatineau. Lake Deschênes, family neighborhoods, bilingual schools — buy or sell with a local specialist." />
