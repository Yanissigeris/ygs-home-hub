...
const reasons = ["Family neighborhoods with access to Lake Deschênes","Proximity to Gatineau Park and trails","Renowned schools and bilingual services","Established community with small-town charm","Quick access to Ottawa via the Champlain Bridge",
];
...
const AylmerPageEn = () => (
 ...
 <CTASection dark title="Buyer or seller in Aylmer?" text="I know Aylmer inside out — let's talk about your project." buttons={[{ label:"Free Valuation", href:"/en/home-valuation" }, { label:"Book a consultation", href:"/en/buyer-consultation", variant:"outline" }]} trustLine="I give you the numbers and the options, you decide." />
