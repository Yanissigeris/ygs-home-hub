...
const FAQPageEn = () => (
  <>
    <PageMeta title="FAQ — Real Estate Questions" description="Answers to frequently asked questions about real estate in Gatineau. Selling, buying, investing, relocation and more." />
