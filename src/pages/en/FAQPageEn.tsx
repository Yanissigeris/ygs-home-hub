...
const FAQPageEn = () => (
 ...
 <CTASection dark title="Have a specific question?" text="Contact me directly — I'll give you a clear and personalized answer." buttons={[{ label:"Talk to Yanis", href:"/en/contact" }, { label:"Free Valuation", href:"/en/home-valuation", variant:"outline" }]} trustLine="I give you the options, you decide." />
 </>
);
