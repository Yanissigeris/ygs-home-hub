...
const SellPlexPageEn = () => (
 <>
 <PageMeta title="Sell a Plex in Gatineau | YGS" description="Sell your duplex, triplex or revenue property in Gatineau. Precise valuation, marketing strategy and specialized support." />
 <HeroSection
 ...
 <CTASection dark title="Ready to explore your options?" text="Request an analysis of your plex — value, revenues and recommendation." buttons={[{ label:"Free Valuation", href:"/en/home-valuation" }, { label:"Free Plex Analysis", href:"/en/plex-analysis", variant:"outline" }]} trustLine="I give you the numbers and the options, you decide." />
