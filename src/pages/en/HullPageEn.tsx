...
const trustItems = [
 ...
 { icon: Shield, label:"Personalized guidance" },
];

const reasons = ["Vibrant downtown with restaurants, culture and neighborhood life","Immediate proximity to downtown Ottawa via bridges","Condos, plexes and homes at competitive prices","Revitalizing area with appreciation potential","Well-developed transit and bike paths",
];
...
const sellerReasons = ["The Hull market is attracting more and more buyers","Area revitalization is increasing interest","Strong demand for well-located plexes and condos","This may be the best time to maximize your price",
];
...
const related = [
 ...
 { title:"Invest in plex", text:"Analysis and strategy for plexes in Gatineau.", href:"/en/plex-investing" },
...
const HullPageEn = () => (
 ...
 trustLine="I give you the numbers, you decide."
 />
