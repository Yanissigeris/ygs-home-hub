...
const reasons = ["Well-established residential neighborhood with all services","Quick access to highways and downtown","Good schools and family parks","Diverse real estate market — houses, semis, condos","Competitive prices compared to Aylmer and Hull",
];
...
const GatineauCentrePageEn = () => (
 ...
 <CTASection dark title="Buyer, seller or investor in Gatineau?" text="I can help — whether you're buying, selling or analyzing a property in the area." buttons={[{ label:"Free Valuation", href:"/en/home-valuation" }, { label:"Book a consultation", href:"/en/buyer-consultation", variant:"outline" }]} trustLine="I give you the numbers and the options, you decide." />
