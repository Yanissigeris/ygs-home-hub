...
const topics = ["How to set the right selling price in Gatineau","Mistakes that cost thousands of dollars","Preparing your property without over-investing","The selling process step by step in Québec","Negotiation: protecting your price with the right strategy","Buy-sell coordination: avoiding getting stuck",
];
...
const SellerGuidePageEn = () => (
 ...
 <CTASection dark title="Ready to take action?" text="Request your free valuation or talk directly to Yanis." buttons={[{ label:"Free Valuation", href:"/en/home-valuation" }, { label:"Talk to Yanis", href:"/en/contact", variant:"outline" }]} trustLine="I give you the numbers and the options, you decide." />
