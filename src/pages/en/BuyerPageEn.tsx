...
const BuyerPageEn = () => (
 ...
 <CTASection dark title="Let's talk about your buying project" text="Budget, neighborhoods, strategy — we clarify everything before starting visits." buttons={[{ label:"Book my consultation", href:"/en/buyer-consultation" }, { label:"Explore neighborhoods", href:"/en/neighborhoods", variant:"outline" }]} trustLine="I give you the numbers and the options, you decide." />
