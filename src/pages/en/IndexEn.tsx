...
{ number:"03", title:"Full support", text:"From preparation to closing, no surprises.", href:"/en/contact" }];
...
<div ref={ref}>
 <PageMeta title="Real Estate Broker Gatineau | YGS" description="Yanis Gauthier-Sigeris, real estate broker in Gatineau. Sell, buy or invest in Outaouais — clear strategy, honest advice and." />
 <HeroSection
 ...
 <p className="mt-4 text-[0.8125rem] text-muted-foreground/45">I give you the numbers and the options, you decide.</p>
 </motion.div>
 </div>
 </section>
