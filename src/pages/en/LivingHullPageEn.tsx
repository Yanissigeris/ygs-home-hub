...
const LivingHullPageEn = () => (
 ...
 <CTASection dark title="Ready to discover Hull?" text="Let's talk about your criteria — I'll show you the best options in the area." buttons={[{ label:"Book a consultation", href:"/en/buyer-consultation" }, { label:"See the neighborhood", href:"/en/hull", variant:"outline" }]} trustLine="I give you the options, you decide." />
