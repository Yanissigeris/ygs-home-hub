...
const MilitaryPageEn = () => (
  <>
    <PageMeta title="Military Relocation Gatineau — CAF Posting" description="Military posting to Gatineau? Specialized support for CAF members: buying, selling, BGRS/SIRVA and smooth settlement." ogImage="https://yanisgauthier.com/og-relocation.jpg" />
