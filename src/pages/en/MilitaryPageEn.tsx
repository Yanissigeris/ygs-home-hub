...
<section className="py-8 bg-card border-y border-border/30"><div className="section-container"><div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8"><p className="text-[0.875rem] text-muted-foreground">Program partner</p><img src={sirvaBgrsLogo} alt="SIRVA | BGRS" width={200} height={36} className="h-10 w-auto object-contain" loading="lazy" decoding="async" /></div></div></section>
    ...
    <ContentBlock narrow><SectionHeading overline="Why YGS" title="A broker who understands your reality" /><p className="prose-body mt-5">Postings don't follow the normal real estate calendar. You need a broker who adapts — to your timeline, your budget, and the pressure that comes with a military move.</p><p className="prose-body mt-4">Since 2017 in Gatineau, I've supported military families in all kinds of situations. My role is to simplify the process so you can focus on your mission.</p><Button className="mt-8" size="lg" asChild><Link to="/en/contact/">Book a call</Link></Button></ContentBlock>
