...
const ContactPageEn = () => {
 ...
 <ProfileSection image={yanisPhoto} imageAlt="Yanis Gauthier-Sigeris" name="Yanis Gauthier-Sigeris" role="Real Estate Broker · Gatineau and Outaouais" subtitle="Affiliated with RE/MAX · Marty Waite Team" logo={logoYgsVertical} logoAlt="YGS">
 ...
 <p className="text-center text-[0.8125rem] text-muted-foreground/50">I give you the numbers and the options, you decide.</p>
 </form>
 )}
 </FormSection>
 <ReviewSection overline="Testimonials" title="What our clients say" reviews={getReviewsById(["s1","b2","r1"])} columns={3} background="alt" />
 <CTASection dark overline="First step" title="Start with the right first step" text="Valuation, buyer consultation or plex analysis — we start where you are." buttons={[{ label:"Free Home Valuation", href:"/en/home-valuation" }, { label:"See services", href:"/en/sell", variant:"outline" }]} trustLine="I give you the numbers and the options, you decide." />
 </>
 );
};
