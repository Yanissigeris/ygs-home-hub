...
const ContactPageEn = () => {
  ...
  return (
    <>
      <PageMeta title="Contact Yanis Gauthier-Sigeris | Real Estate Broker Gatineau | YGS" description="Get in touch with Yanis Gauthier-Sigeris, real estate broker in Gatineau. Free consultation — let's talk about your project." ogImage="https://yanisgauthier.com/og/og-default.jpg" />
