...
const PlateauAylmerPageEn = () => (
 ...
 <CTASection dark title="Buyer or seller in Plateau / Aylmer?" text="I can help you find the right property or know the value of yours." buttons={[{ label:"Free Valuation", href:"/en/home-valuation" }, { label:"Book a consultation", href:"/en/buyer-consultation", variant:"outline" }]} trustLine="I give you the numbers, you decide." />
