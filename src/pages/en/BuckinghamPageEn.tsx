...
const reasons = ["Bigger lots and more spacious properties","Among the most affordable entry prices in Outaouais","Natural setting — rivers, parks, green spaces","Ideal for families who want space without leaving the region","Growing area with new developments",
];
...
const sellerReasons = ["Demand is growing in the area with new developments","Buyers are looking for space — your property interests them","Take advantage of rising values before prices stabilize","Optimize your position for your next real estate project",
];
