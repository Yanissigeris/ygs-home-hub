...
const MilitaryRelocationPageEn = () => (
 ...
 <HeroSection overline="Military Relocation · Gatineau" title="Military relocation to Gatineau" subtitle="Posting to the area? I help you find the right property quickly, stress-free and on your timeline." primaryCta={{ label:"Book a call", href:"/en/contact" }} trustLine="Service adapted to military members." heroBgImage={heroImg} />
 ...
 <CTASection dark title="Let's plan your relocation" text="Tell me about your posting — we'll build a plan together." buttons={[{ label:"Book a call", href:"/en/contact" }, { label:"Free Valuation", href:"/en/home-valuation", variant:"outline" }]} trustLine="I give you the options, you decide." />
