...
const NeighborhoodsPageEn = () => (
 ...
 <CTASection dark title="Need help choosing?" text="Let's talk about your criteria — I'll recommend the neighborhoods best suited to your situation." buttons={[{ label:"Book a consultation", href:"/en/buyer-consultation" }, { label:"Get my valuation", href:"/en/home-valuation", variant:"outline" }]} trustLine="I give you the options, you decide." />
