...
<SectorLinks overline="Explore neighborhoods" title="Some Outaouais neighbourhoods" sectors={sectors} />
    <ContentBlock narrow><SectionHeading title="Every neighborhood has its character" /><p className="prose-body mt-5">The right area depends on your budget, commute, lifestyle and family priorities. Since 2017 in Outaouais, I know the advantages and trade-offs of each neighborhood — and I can help you choose the right one.</p></ContentBlock>
