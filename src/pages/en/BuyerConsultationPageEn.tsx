...
const benefits = ["Personalized discussion about your criteria and priorities","Overview of neighborhoods suited to your profile","Explanation of the buying process in Québec","Current market reading and prices by area","Clear next steps, no commitment",
];
