    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <motion.div className="absolute bottom-0 right-[2%] lg:right-[4%] xl:right-[8%] hidden md:block pointer-events-none select-none" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 0.2, y: 0 }} transition={{ duration: 1, ease: [0.22, 1, 0.36, 1], delay: 0.15 }} aria-hidden="true">
          <div style={{ maskImage: 'linear-gradient(to top, transparent 0%, black 20%)', WebkitMaskImage: 'linear-gradient(to top, transparent 0%, black 20%)' }}><img src={yanisPhoto} alt="" className="w-[380px] lg:w-[440px] xl:w-[500px] object-contain object-bottom" loading="eager" /></div>
        </motion.div>
              ...
              <div className="rounded-[1.25rem] border border-white/[0.08] bg-white/[0.06] backdrop-blur-xl shadow-[0_8px_40px_-12px_hsl(200_40%_8%_/_0.5)] p-6 sm:p-8">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                    <div><Label htmlFor="address" className="text-primary-foreground/60 text-[0.8125rem]">Property address</Label><Input id="address" placeholder="123 Example St, Gatineau" className="mt-1 bg-white/[0.06] border-white/[0.1] text-primary-foreground placeholder:text-primary-foreground/25 focus-visible:ring-accent/30 h-11" required /></div>
                    <div className="grid gap-4 sm:grid-cols-2"><div><Label htmlFor="name" className="text-primary-foreground/60 text-[0.8125rem]">Name</Label><Input id="name" className="mt-1 bg-white/[0.06] border-white/[0.1] text-primary-foreground placeholder:text-primary-foreground/25 focus-visible:ring-accent/30 h-11" required /></div><div><Label htmlFor="email" className="text-primary-foreground/60 text-[0.8125rem]">Email</Label><Input id="email" type="email" className="mt-1 bg-white/[0.06] border-white/[0.1] text-primary-foreground placeholder:text-primary-foreground/25 focus-visible:ring-accent/30 h-11" required /></div></div>
                    <div><Label htmlFor="phone" className="text-primary-foreground/60 text-[0.8125rem]">Phone</Label><Input id="phone" type="tel" className="mt-1 bg-white/[0.06] border-white/[0.1] text-primary-foreground placeholder:text-primary-foreground/25 focus-visible:ring-accent/30 h-11" /></div>
                    <Button type="submit" size="xl" variant="accent" className="w-full mt-1 shadow-[0_4px_20px_-4px_hsl(36_45%_48%_/_0.35)] font-semibold"><Send size={16} className="mr-1.5" />Get my free valuation</Button>
                    <div className="flex flex-wrap justify-center gap-x-5 gap-y-1.5 pt-1 text-[0.75rem] text-primary-foreground/30"><span className="flex items-center gap-1.5"><BadgeCheck size={13} /> Free</span><span className="flex items-center gap-1.5"><Lock size={13} /> Confidential</span><span className="flex items-center gap-1.5"><Shield size={13} /> No commitment</span></div>
                  </form>
                )}
              </div>
            </motion.div>
