...
const LivingAylmerPageEn = () => (
 <>
 <PageMeta title="Living in Aylmer — Lifestyle Guide | YGS" description="Everything about life in Aylmer: lake, restaurants, schools, community and quality of life. Your guide to settling in Aylmer." />
 ...
 <CTASection dark title="Ready to discover Aylmer?" text="Let's talk about your criteria — I'll show you the best options in the area." buttons={[{ label:"Book a consultation", href:"/en/buyer-consultation" }, { label:"See the neighborhood", href:"/en/aylmer", variant:"outline" }]} trustLine="I give you the options, you decide." />
