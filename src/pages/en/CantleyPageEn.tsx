...
const CantleyPageEn = () => (
  <NeighborhoodTemplate
    seoTitle="Cantley QC — Neighborhood Guide | YGS"
    metaDesc="Buy, sell or live in Cantley, Quebec. Rolling hills, large lots and rural tranquility — 20 minutes from Gatineau."
