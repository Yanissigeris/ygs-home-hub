...
<SectorLinks
    ...
    <ContentBlock narrow>
      ...
      <p className="prose-body mt-5">
        Le bon secteur dépend de votre budget, votre trajet, votre style de vie et vos priorités familiales. Depuis 2017 à Gatineau, je connais les avantages et les compromis de chaque quartier — et je peux vous aider à choisir le bon.
      </p>
    </ContentBlock>
