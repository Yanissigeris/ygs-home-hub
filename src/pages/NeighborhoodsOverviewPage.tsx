...
const NeighborhoodsOverviewPage = () => (
   <>
    <PageMeta title="Quartiers de Gatineau — Guide complet | YGS" description="Comparez les quartiers de Gatineau et de l'Outaouais: Aylmer, Hull, Plateau, Buckingham et Gatineau-centre. Prix, ambiance, écoles et profil de chaque secteur." ogImage="https://yanisgauthier.com/og-neighborhoods.jpg" />
    <HeroSection
