...
const PlexPage = () => (
   <>
    <PageMeta title="Investir dans un plex à Gatineau · Outaouais | YGS" description="Duplex, triplex et immeubles à revenus à Gatineau. Analyse de rendement et stratégie d'investissement par un courtier spécialisé." ogImage="https://yanisgauthier.com/og-plex.jpg" />
