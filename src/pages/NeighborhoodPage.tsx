...
const NeighborhoodPage = () => (
   <>
    <PageMeta title="Plateau et Aylmer — Guide de quartier | YGS" description="Découvrez le Plateau et Aylmer à Gatineau. Quartiers familiaux, lac Deschênes, nature, écoles et propriétés. Guide complet par un courtier local en Outaouais." />
