...
const AylmerPage = () => (
   <>
    <PageMeta title="Aylmer — Guide de quartier Gatineau | YGS" description="Vivre, acheter ou vendre à Aylmer, Gatineau. Lac Deschênes, parc de la Gatineau, écoles bilingues et communauté — guide complet par un courtier local." />
