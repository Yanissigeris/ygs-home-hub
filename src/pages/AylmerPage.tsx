...
const reasons = ["Quartiers familiaux avec accès au lac Deschênes","Proximité du parc de la Gatineau et des sentiers","Écoles réputées et services bilingues","Communauté établie avec charme de petite ville","Accès rapide à Ottawa par le pont Champlain",
];
