...
const MilitaryGuidePage = () => (
   <>
    <PageMeta title="Guide militaire — Immobilier à Gatineau" description="Guide immobilier pour militaires FAC à Gatineau. BGRS, SIRVA, BFC Uplands, quartiers recommandés (Aylmer, Plateau, Hull) et conseils pratiques." ogImage="https://yanisgauthier.com/og/og-military.jpg" />
    <HeroSection
