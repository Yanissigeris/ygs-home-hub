...
const topics = ["Comprendre les réalités d'une mutation immobilière","Acheter vs louer lors d'une relocalisation militaire","Les meilleurs secteurs de Gatineau pour les familles militaires","Le processus d'achat au Québec — étape par étape","Vendre rapidement lors d'une mutation sans sacrifier le prix","Programmes et ressources disponibles pour les militaires",
];
...
const MilitaryGuidePage = () => (
 ...
 trustLine="je m'adapte à votre rythme."
 />
