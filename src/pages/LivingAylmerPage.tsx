...
const LivingAylmerPage = () => (
   <>
    <PageMeta title="Vivre à Aylmer · Gatineau — Mode de vie | YGS" description="Tout sur la vie à Aylmer, Gatineau: lac Deschênes, restaurants, écoles bilingues, communauté et qualité de vie. Le guide pour s'installer à Aylmer." />
    <HeroSection
