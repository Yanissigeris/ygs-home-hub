...
const benefits = ["Échange personnalisé sur vos critères et priorités","Présentation des secteurs adaptés à votre profil","Explication du processus d'achat au Québec","Lecture du marché actuel et des prix par secteur","Prochaines étapes claires, sans engagement",
];
