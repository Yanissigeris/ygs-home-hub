...
const benefits = ["Fourchette de valeur réaliste basée sur les ventes récentes","Avis sur le positionnement prix pour votre situation","Forces de votre propriété à mettre de l'avant","Points à corriger — et lesquels valent la peine","Prochaines étapes possibles, sans engagement",
];
